...
+(CCScene *) scene
{
	...
	GameLayer *layer = [CreditLayer node];
...
-(id) init
{
	...
	if( (self=[super init]) ) {
        ...
        backButton.position = ccp(size.width * 6/7 + 12, size.height/7*6);
